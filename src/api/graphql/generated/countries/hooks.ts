...
export type GetCountriesQuery = { __typename?: 'Query', countries: Array<{ __typename?: 'Country', awsRegion: string, capital?: string | null, code: string, currency?: string | null, emojiU: string, native: string, phone: string, continent: { __typename?: 'Continent', name: string, code: string }, languages: Array<{ __typename?: 'Language', name: string }> }> };
...
export const useGetCountriesQuery = <
    ...
    queryFn: graphqlFetcherCountries<GetCountriesQuery, GetCountriesQueryVariables>(GetCountriesDocument, variables),
    ...options
  }
    )};
