...
export const Wrapper = styled.div`
  ...
  box-shadow: 0 4px 4px 0 rgba(45, 51, 68, 0.2), 0 8px 8px 0 rgba(36, 42, 59, 0.2), 0 16px 16px 0 rgba(37, 44, 61, 0.2), 0 32px 32px 0 rgba(37, 44, 61,.2), 0 64px 64px 0 rgba(37, 44, 61,.2), 0 128px 128px 0 rgba(37, 44, 61,.2);
`;
